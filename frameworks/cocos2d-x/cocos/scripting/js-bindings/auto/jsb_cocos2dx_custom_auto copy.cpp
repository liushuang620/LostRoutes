...
bool js_cocos2dx_custom_CustomClass_init(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    coso2d::CustomClass* cobj = (coso2d::CustomClass *)(proxy ? proxy->ptr : NULL);
...
bool js_cocos2dx_custom_CustomClass_create(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 0) {
        ...
        auto ret = coso2d::CustomClass::create();
        js_type_class_t *typeClass = js_get_type_from_native<coso2d::CustomClass>(ret);
...
bool js_cocos2dx_custom_CustomClass_constructor(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    coso2d::CustomClass* cobj = new (std::nothrow) coso2d::CustomClass();

    js_type_class_t *typeClass = js_get_type_from_native<coso2d::CustomClass>(cobj);
...
void js_register_cocos2dx_custom_CustomClass(JSContext *cx, JS::HandleObject global) {
    ...
    jsb_register_class<coso2d::CustomClass>(cx, jsb_coso2d_CustomClass_class, proto, JS::NullPtr());
}
